...
tex_font_metrics_t* load_tex_font_metrics( char *filename )
{
	...
	READ_BYTES( tfm_file, &ch_dims.x_offset, sizeof(signed char), False );
	READ_BYTES( tfm_file, &ch_dims.y_offset, sizeof(signed char), False );
	READ_BYTES( tfm_file, &ch_dims.kern_width, sizeof(unsigned char), False );
